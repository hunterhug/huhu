...
这是一个获取某乎回答的小工具, 可以获取单个问题, 单个收藏夹, 单个人下面的回答, 支持下载图片, 生成HTML离线查看, 工具下载请前往(请下载最新版本): [http://hunterhug.github.io/other/app/huhu.zip](http://hunterhug.github.io/other/app/huhu.zip)
